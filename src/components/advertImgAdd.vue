...
<template>
  <section class="wrap">
    ...
    <el-breadcrumb class="breadcrumb" separator="/">
      ...
      <el-breadcrumb-item :to="{ path: path.path }">{{path.name}}</el-breadcrumb-item>
...
export default {
  ...
  methods: {
    ...
    handleAvatarSuccess(res, file) {
      ...
      console.log(res);
      this.form.url = res.data.base_url;
    ...
    postImg() {
      ...
      this.$api.postAdvert(this.form, res => {
        this.$message({
          type: "success",
          message: "新增成功"
        });
